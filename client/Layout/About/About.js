    ...
    <div>
      ...
      <div style={{textAlign: 'center'}}>
        ...
        <div className="about-text">
          ...
          <div>I participate in <span className="emphasized">hackathons</span> around the country, work on personal projects on <span className="emphasized"><a className="no-decoration" href="https://github.com/klin1344">Github</a></span>, and hack on random stuff.</div>
          <br/>
          <div>This summer I was a <span className="emphasized">Software Engineer Intern</span> at <span className="emphasized"><a className="no-decoration" href="http://www.qrigroup.com/">QRI International</a></span> in Houston, TX.  I received a return offer and have joined the team as a contracted <span className="emphasized">Software Engineer</span>.</div>
        </div>
